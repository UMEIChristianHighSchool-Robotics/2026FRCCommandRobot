...
public class AutoSequenceCommand extends SequentialCommandGroup {
  ...
  public AutoSequenceCommand(DiffDriveSubsystem m_driveSubsystem, SnowPlowSubsystem m_intakeSubsystem) {
    ...
    new AutoDriveCommand(m_driveSubsystem,0.5,  0.0).withTimeout(.25),
    // Spin up the launcher for 1 second and then launch balls for 9 seconds, for a
    // total of 10 seconds
    new LaunchCommand(m_intakeSubsystem).withTimeout(10));
  }
}
